...
### Příprava
Abyste byli schopni spustit níže uvedené příkazy, je nutné mít nainstalované [Ruby 3.3](https://www.ruby-lang.org/en/documentation/installation/), které je [výchozí v Debianu](https://packages.debian.org/trixie/ruby), a GNU Make.
